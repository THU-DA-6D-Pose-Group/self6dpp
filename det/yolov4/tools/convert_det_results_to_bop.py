...
def get_parser():
    ...
    parser.add_argument(
        ...
        help="path to prediction results (instances_predictions.pth)",
    )
    parser.add_argument("--dataset", default="lmo_bop_test", help="registered dataset name")
    return parser
...
def main():
    ...
    inout.save_json(result_path, bop_results)
