...
class ResNet(nn.Module):
    ...
    def make_stage_plugins(self, plugins, stage_idx):
        """make plugins for ResNet 'stage_idx'th stage . Currently we support
...
class ResNetV1c(ResNet):
    """ResNetV1c variant described in [1] `Bag of Tricks`
...
class ResNetV1d(ResNet):
    # NOTE: to use pretrained weights, use mmcls_resnet version
    """ResNetV1d variant described in [1] `Bag of Tricks` Compared with default
