...
if __name__ == "__main__":
    ...
    new_res_path = osp.join(
        PROJ_ROOT,
        "datasets/BOP_DATASETS/lm/test/init_poses/resnest50d_a6_AugCosyAAEGray_BG05_mlBCE_lm_pbr_100e_so_wFasterRcnnPbrBboxGdrnInit_wDeepimPbrPose_lm_13_all.json",
    )
