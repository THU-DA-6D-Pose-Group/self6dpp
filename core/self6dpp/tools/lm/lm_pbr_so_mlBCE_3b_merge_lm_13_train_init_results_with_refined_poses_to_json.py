...
if __name__ == "__main__":
    ...
    pkl_paths = [
        "ape/inference_model_final_wo_optim-c5ab39d4/lm_real_ape_train/results.pkl",
        "benchvise/inference_model_final_wo_optim-956eb2eb/lm_real_benchvise_train/results.pkl",
        "camera/inference_model_final_wo_optim-520e2c6d/lm_real_camera_train/results.pkl",
        "can/inference_model_final_wo_optim-29275594/lm_real_can_train/results.pkl",
        "cat/inference_model_final_wo_optim-bd14a802/lm_real_cat_train/results.pkl",
        "driller/inference_model_final_wo_optim-45c5dd36/lm_real_driller_train/results.pkl",
        "duck/inference_model_final_wo_optim-e28d46ee/lm_real_duck_train/results.pkl",
        "eggbox/inference_model_final_wo_optim-bb583866/lm_real_eggbox_train/results.pkl",
        "glue/inference_model_final_wo_optim-8013fa70/lm_real_glue_train/results.pkl",
        "holepuncher/inference_model_final_wo_optim-30e67e31/lm_real_holepuncher_train/results.pkl",
        "iron/inference_model_final_wo_optim-485fd5c3/lm_real_iron_train/results.pkl",
        "lamp/inference_model_final_wo_optim-f169005c/lm_real_lamp_train/results.pkl",
        "phone/inference_model_final_wo_optim-61aad172/lm_real_phone_train/results.pkl",
    ]
