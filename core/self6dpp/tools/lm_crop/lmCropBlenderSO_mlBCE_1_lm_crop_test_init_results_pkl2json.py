...
if __name__ == "__main__":
    new_res_path = osp.join(
        ...
        "resnest50d_a6_AugCosyAAEGray_BG05_mlBCE_bboxCrop_DZI10_lm_blender_100e_so_lmCropTest_GdrnPose_with_bbox_crop.json",
    )
    ...
    pred_paths = [
        "ape/inference_model_final_wo_optim-ab325295/lm_crop_ape_test/results.pkl",
        "benchvise/inference_model_final_wo_optim-cba7da41/lm_crop_benchvise_test/results.pkl",
        "camera/inference_model_final_wo_optim-5055333e/lm_crop_camera_test/results.pkl",
        "can/inference_model_final_wo_optim-889ae475/lm_crop_can_test/results.pkl",
        "cat/inference_model_final_wo_optim-c754e587/lm_crop_cat_test/results.pkl",
        "driller/inference_model_final_wo_optim-c1cc7169/lm_crop_driller_test/results.pkl",
        "duck/inference_model_final_wo_optim-084c3364/lm_crop_duck_test/results.pkl",
        "holepuncher/inference_model_final_wo_optim-86d52ab7/lm_crop_holepuncher_test/results.pkl",
        "iron/inference_model_final_wo_optim-6bdb61b0/lm_crop_iron_test/results.pkl",
        "lamp/inference_model_final_wo_optim-bf52eba3/lm_crop_lamp_test/results.pkl",
        "phone/inference_model_final_wo_optim-4172540b/lm_crop_phone_test/results.pkl",
    ]
