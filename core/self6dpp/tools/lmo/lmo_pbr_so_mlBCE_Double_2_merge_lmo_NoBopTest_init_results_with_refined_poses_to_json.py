...
if __name__ == "__main__":
    new_res_path = osp.join(
        ...
        "resnest50d_online_AugCosyAAEGray_mlBCE_DoubleMask_lmo_pbr_100e_so_withYolov4PbrBbox_wDeepimPbrPose_lmo_NoBopTest_train.json",
    )
    ...
    pkl_paths = [
        "ape/inference_model_final_wo_optim-c5ab39d4/lmo_NoBopTest_train/results.pkl",
        "can/inference_model_final_wo_optim-29275594/lmo_NoBopTest_train/results.pkl",
        "cat/inference_model_final_wo_optim-bd14a802/lmo_NoBopTest_train/results.pkl",
        "driller/inference_model_final_wo_optim-45c5dd36/lmo_NoBopTest_train/results.pkl",
        "duck/inference_model_final_wo_optim-e28d46ee/lmo_NoBopTest_train/results.pkl",
        "eggbox/inference_model_final_wo_optim-bb583866/lmo_NoBopTest_train/results.pkl",
        "glue/inference_model_final_wo_optim-8013fa70/lmo_NoBopTest_train/results.pkl",
        "holepuncher/inference_model_final_wo_optim-30e67e31/lmo_NoBopTest_train/results.pkl",
    ]
