...
data_root = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/lmo/train_pbr"))
...
if __name__ == "__main__":
    ...
    dset_name = "lmo_pbr_driller_train"
    iprint(dset_name)
    ...
    def process_single(dic_id):
        ...
        im_path = osp.join(data_root, f"{scene_id:06d}/rgb/{im_id:06d}.jpg")
    ...
    sel_ids = all_ids[:VIS_NUM]
    tic = time.perf_counter()
    for sel_id in tqdm(sel_ids):
