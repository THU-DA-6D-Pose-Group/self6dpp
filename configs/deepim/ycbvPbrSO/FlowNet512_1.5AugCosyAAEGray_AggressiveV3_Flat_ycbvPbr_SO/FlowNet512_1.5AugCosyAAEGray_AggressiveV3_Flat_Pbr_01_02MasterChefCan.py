...
OUTPUT_DIR = "output/deepim/ycbvPbrSO/FlowNet512_1.5AugCosyAAEGray_AggressiveV3_Flat_ycbvPbr_SO/01_02MasterChefCan"
INPUT = dict(
    COLOR_AUG_PROB=0.8,
    COLOR_AUG_TYPE="code",
    COLOR_AUG_CODE=(
    ...
    NOISE_TRANS_STD_TRAIN=[(0.02, 0.02, 0.1), (0.01, 0.01, 0.05), (0.01, 0.01, 0.01), (0.005, 0.005, 0.01)],
