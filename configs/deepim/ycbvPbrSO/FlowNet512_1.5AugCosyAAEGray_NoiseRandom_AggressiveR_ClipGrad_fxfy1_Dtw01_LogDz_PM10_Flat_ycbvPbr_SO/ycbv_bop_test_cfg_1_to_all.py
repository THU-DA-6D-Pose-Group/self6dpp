...
base_cfg_name = "FlowNet512_1.5AugCosyAAEGray_NoiseRandom_AggressiveR_ClipGrad_fxfy1_Dtw01_LogDz_PM10_Flat_Pbr_01_02MasterChefCan_bop_test.py"
...
def main():
    ...
    for obj_id, obj_name in tqdm(id2obj.items()):
        ...
        new_cfg_dict = dict(
            ...
            DATASETS=dict(
                TRAIN=(f"ycbv_{obj_name}_train_pbr",),
            ),
        )
        # ----------------------------------------------------------------------
