...
OUTPUT_DIR = "output/gdrn/lmoRealPbrSO/resnest50d_online_AugCosyAAEGray_mlBCE_DoubleMask_lmoRealNBPbr_100e_SO/ape"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("lmo_pbr_ape_train", "lmo_NoBopTest_ape_train"),
    TEST=("lmo_bop_test",),
    # AP	AP50	AP75	AR	inf.time
    # 64.28 	89.71 	74.24	72.7	22.4ms
    DET_FILES_TEST=(
