...
./core/gdrn_modeling/test_gdrn.sh \
  ...
  DATASETS.DET_FILES_TEST="datasets/hb_bench_driller_phone/test_bboxes/yolov4x_640_augCosyAAEGray_ranger_lm_pbr_hb_bdp_test.json," \
  DATASETS.TEST="hb_bdp_benchvise_test,"
...
./core/gdrn_modeling/test_gdrn.sh \
  ...
  DATASETS.DET_FILES_TEST="datasets/hb_bench_driller_phone/test_bboxes/yolov4x_640_augCosyAAEGray_ranger_lm_pbr_hb_bdp_test.json," \
  DATASETS.TEST="hb_bdp_driller_test,"
...
./core/gdrn_modeling/test_gdrn.sh \
  ...
  DATASETS.DET_FILES_TEST="datasets/hb_bench_driller_phone/test_bboxes/yolov4x_640_augCosyAAEGray_ranger_lm_pbr_hb_bdp_test.json," \
  DATASETS.TEST="hb_bdp_phone_test,"
