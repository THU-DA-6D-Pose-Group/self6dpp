...
OUTPUT_DIR = "output/gdrn/lmoPbrSO/resnest50d_online_AugCosyAAEGray_mlBCE_DoubleMask_lmo_pbr_100e/eggbox"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
TEST = dict(EVAL_PERIOD=0, VIS=False, TEST_BBOX_TYPE="est", COLOR_AUG=True)  # gt | est
