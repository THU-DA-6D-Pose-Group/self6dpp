...
OUTPUT_DIR = "output/gdrn/lmoPbrSO/resnest50d_online_AugCosyAAEGray_mlBCE_DoubleMask_lmo_pbr_100e/holepuncher"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
# holepuncher  0.33      7.52      27.19     13.22    67.60    94.21     22.56  67.60  94.30   49.01  96.36  97.02   10.25    84.21    96.45
