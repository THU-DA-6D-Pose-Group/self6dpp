...
OUTPUT_DIR = "output/yolov4/lm/yolov4x_640_augCosyAAEGray_ranger_lm_pbr_hb_bdp_test"
...
# bbnc6
# [0327_164625 det.yolov4.engine.yolov4_coco_evaluation@275]: Evaluation results for bbox:
# |   AP   |  AP50  |  AP75  |  APs   |  APm   |  APl   |
# |:------:|:------:|:------:|:------:|:------:|:------:|
# | 83.655 | 98.772 | 96.276 | 35.000 | 84.957 | 83.685 |
# [0327_164625 det.yolov4.engine.yolov4_coco_evaluation@303]: Per-category bbox AP:
# | category   | AP     | category   | AP     | category   | AP     | category   | AP   | category    | AP   |
# |:-----------|:-------|:-----------|:-------|:-----------|:-------|:-----------|:-----|:------------|:-----|
# | ape        | nan    | benchvise  | 77.945 | camera     | nan    | can        | nan  | cat         | nan  |
# | driller    | 89.700 | duck       | nan    | eggbox     | nan    | glue       | nan  | holepuncher | nan  |
# | iron       | nan    | lamp       | nan    | phone      | 83.319 |            |      |             |      |
# [0327_164625 det.yolov4.engine.yolov4_coco_evaluation@333]: Per-category bbox AR:
# | category   | AR     | category   | AR     | category   | AR     | category   | AR   | category    | AR   |
# |:-----------|:-------|:-----------|:-------|:-----------|:-------|:-----------|:-----|:------------|:-----|
# | ape        | nan    | benchvise  | 81.976 | camera     | nan    | can        | nan  | cat         | nan  |
# | driller    | 92.518 | duck       | nan    | eggbox     | nan    | glue       | nan  | holepuncher | nan  |
# | iron       | nan    | lamp       | nan    | phone      | 87.012 |            |      |             |      |
