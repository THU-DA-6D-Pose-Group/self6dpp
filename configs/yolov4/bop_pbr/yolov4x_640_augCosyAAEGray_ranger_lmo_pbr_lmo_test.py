...
# [0102_100557 det.yolov4.engine.yolov4_coco_evaluation@277]: Evaluation results for bbox:
# |   AP   |  AP50  |  AP75  |  APs   |  APm   |  APl   |
# |:------:|:------:|:------:|:------:|:------:|:------:|
# | 66.145 | 91.742 | 77.288 | 37.970 | 70.596 | 69.002 |
# [0102_100557 det.yolov4.engine.yolov4_coco_evaluation@309]: Per-category bbox AP:
# | category   | AP     | category   | AP     | category    | AP     | category   | AP     | category   | AP     |
# |:-----------|:-------|:-----------|:-------|:------------|:-------|:-----------|:-------|:-----------|:-------|
# | ape        | 59.867 | can        | 81.650 | cat         | 63.811 | driller    | 77.610 | duck       | 73.486 |
# | eggbox     | 41.713 | glue       | 54.444 | holepuncher | 76.581 |            |        |            |        |
# [0102_100557 det.yolov4.engine.yolov4_coco_evaluation@339]: Per-category bbox AR:
# | category   | AR     | category   | AR     | category    | AR     | category   | AR     | category   | AR     |
# |:-----------|:-------|:-----------|:-------|:------------|:-------|:-----------|:-------|:-----------|:-------|
# | ape        | 69.060 | can        | 85.302 | cat         | 72.721 | driller    | 83.056 | duck       | 78.801 |
# | eggbox     | 58.070 | glue       | 63.030 | holepuncher | 82.554 |            |        |            |        |
