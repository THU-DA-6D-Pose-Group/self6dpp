...
OUTPUT_DIR = "output/self6dpp/ssHB/ss_dibr_mlBCE_FreezeBN_woCenter_woDepth_refinePM10/benchvise"
INPUT = dict(
    WITH_DEPTH=True,
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
...
DATASETS = dict(
    TRAIN=("hb_bdp_benchvise_train_lmK",),  # real data
    TRAIN2=("lm_pbr_benchvise_train",),  # synthetic data
    TRAIN2_RATIO=0.0,
    TEST=("hb_bdp_benchvise_test_lmK",),
