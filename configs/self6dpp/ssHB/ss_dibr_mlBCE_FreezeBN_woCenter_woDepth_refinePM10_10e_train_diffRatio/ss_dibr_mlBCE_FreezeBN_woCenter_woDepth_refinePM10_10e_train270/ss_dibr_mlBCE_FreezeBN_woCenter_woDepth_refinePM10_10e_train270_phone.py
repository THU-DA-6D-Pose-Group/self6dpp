...
OUTPUT_DIR = "output/self6dpp/ssHB/ss_dibr_mlBCE_FreezeBN_woCenter_woDepth_refinePM10_10e_train270/phone"

DATASETS = dict(
    TRAIN=("hb_bdp_phone_train270_lmK",),  # real data
    TRAIN2=("lm_pbr_phone_train",),  # synthetic data
    TEST=("hb_bdp_phone_test100_lmK",),
)
