...
OUTPUT_DIR = "output/self6dpp/ssHB/ss_dibr_mlBCE_FreezeBN_woCenter_woDepth_refinePM10_10e_train090/benchvise"
INPUT = dict(
    WITH_DEPTH=True,
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
...
DATASETS = dict(
    TRAIN=("hb_bdp_benchvise_train090_lmK",),  # real data
