...
OUTPUT_DIR = "output/self6dpp/ssLMCrop/FreezeBN_20e_Blender08_bboxCrop_woDepth_refinePM100_blenderCrop_DZI10/ape"
INPUT = dict(
    WITH_DEPTH=True,
    DZI_PAD_SCALE=1.0,
    TRUNCATE_FG=False,
...
DATASETS = dict(
    ...
    DET_FILES_TRAIN=(
        "datasets/BOP_DATASETS/lm/test/init_poses/resnest50d_a6_AugCosyAAEGray_BG05_mlBCE_bboxCrop_DZI10_lm_blender_100e_so_GdrnPose_wBboxCrop_wDeepimPose_lmCropTrain.json",
    ),
    DET_THR_TRAIN=0.5,
)
...
MODEL = dict(
    ...
    WEIGHTS="output/gdrn/lm_crop_blender/resnest50d_a6_AugCosyAAEGray_BG05_mlBCE_bboxCrop_DZI10_lm_blender_100e/ape/model_final_wo_optim-ab325295.pth",
    REFINER_WEIGHTS="",
    FREEZE_BN=True,
