...
def main():
    # NOTE: just change the output_path and filenames!
    parser = argparse.ArgumentParser(description="gen lmo cfgs from another base cfgs")
    ...
    assert old != new, f"{old} and {new} are the same configurations!"
